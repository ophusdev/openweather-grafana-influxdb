...
scheduler.add_job(current_weather, 'interval', minutes=int(os.getenv('FLASK_CURRENT_WEATHER_DELAY'))) 
scheduler.add_job(forecast_weather, 'interval', minutes=int(os.getenv('FLASK_FORECAST_WEATHER_DELAY'))) 
scheduler.start() 
